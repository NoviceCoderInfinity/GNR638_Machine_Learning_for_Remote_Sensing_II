...
def get_tiny_images(image_paths, size=16):
    """
    Resize images to a small square resolution and flatten them for feature extraction.

    Args:
        image_paths: List of image file paths.
        size: Size to which each image will be resized (default is 16 for tiny images).

    Returns:
        Numpy array of resized and flattened images.
    """
